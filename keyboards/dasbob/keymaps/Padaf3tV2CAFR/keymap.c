...
#define HRM_E       LSFT_T(FR_E)   
#define HRM_U       LT(SYM, FR_U)   
#define HRM_K       LGUI_T(FR_K)
#define HRM_Y       LALT_T(FR_Y)
#define HRM_DOT     LCTL_T(FR_DOT)
#define HRM_BSPC    LT(NAV, FR_BSPC)

#define HRM_T       LT(SYM, FR_T)
#define HRM_S       LSFT_T(FR_S)
#define HRM_R       LT(TREM, FR_R)
#define HRM_N       LT(CIRC, FR_N)
#define HRM_C       LCTL_T(FR_C)
#define HRM_H       LALT_T(FR_H)
#define HRM_V       LGUI_T(FR_V)

#define HRM_0       LT(SYM, FR_0)
#define HRM_2       LSFT_T(FR_2)
#define HRM_SPC     LCTL_T(KC_SPC)
#define HRM_1       LT(SYM, FR_1)
#define HRM_3       LSFT_T(FR_3)
